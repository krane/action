...
class KraneAction {
    ...
    saveDeployment() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.client.saveDeployment(this.config);
    ...
    runDeployment() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.client.runDeployment(deployment);
            core.info(`Deployment ${deployment} triggered succesfully`);
            core.endGroup();
        });
    }
}
exports.KraneAction = KraneAction;
...
const resolveConfig = (path) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const tag = (_a = core.getInput("tag")) !== null && _a !== void 0 ? _a : "latest";
    if (config.tag == null) {
        config.tag = tag;
    }
...
const run = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const action = new action_1.KraneAction(client, config);
    yield action.saveDeployment();
    yield action.runDeployment();
});
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.KraneApiException = void 0;
var KraneApiException = /** @class */ (function (_super) {
    __extends(KraneApiException, _super);
    function KraneApiException(message) {
        var _this = _super.call(this, message) || this;
        _this.name = "KraneApiException";
        _this.stack = new Error().stack;
        return _this;
    }
    return KraneApiException;
}(Error));
exports.KraneApiException = KraneApiException;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.KraneClient = void 0;
var axios_1 = __importDefault(__webpack_require__(6545));
var exceptions_1 = __webpack_require__(4973);
var KraneClient = /** @class */ (function () {
    function KraneClient(endpoint, token) {
        this.client = axios_1.default.create({
            baseURL: endpoint,
            headers: { Authorization: "Bearer " + token },
        });
    }
    KraneClient.prototype.login = function () {
        return __awaiter(this, void 0, void 0, function () {
            var path, data;
    ...
    KraneClient.prototype.auth = function (request_id, token) {
        return __awaiter(this, void 0, void 0, function () {
            var path, body, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/auth";
                        body = { request_id: request_id, token: token };
    ...
    KraneClient.prototype.getDeployment = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    KraneClient.prototype.getDeployments = function () {
        return __awaiter(this, void 0, void 0, function () {
            var path, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    KraneClient.prototype.saveDeployment = function (config) {
        return __awaiter(this, void 0, void 0, function () {
            var path, _a, status, data;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        path = "/deployments";
                        return [4 /*yield*/, this.client.post(path, config)];
                    case 1:
                        _a = _b.sent(), status = _a.status, data = _a.data;
                        if (status != 200) {
                            throw new exceptions_1.KraneApiException("Unable to save deployment");
                        }
                        return [2 /*return*/, data];
                }
            });
    ...
    KraneClient.prototype.deleteDeployment = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (status != 202) {
                            throw new exceptions_1.KraneApiException("Unable to delete deployment");
                        }
                        return [2 /*return*/];
                }
            });
    ...
    KraneClient.prototype.runDeployment = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/deployments/" + deployment;
                        return [4 /*yield*/, this.client.post(path)];
                    case 1:
                        status = (_a.sent()).status;
                        if (status != 202) {
                            throw new exceptions_1.KraneApiException("Unable to run deployment");
                        }
                        return [2 /*return*/];
                }
            });
    ...
    KraneClient.prototype.startDeployment = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/deployments/" + deployment + "/containers/start";
                        return [4 /*yield*/, this.client.post(path)];
                    case 1:
                        status = (_a.sent()).status;
                        if (status != 202) {
                            throw new exceptions_1.KraneApiException("Unable to start deployment");
                        }
                        return [2 /*return*/];
                }
            });
    ...
    KraneClient.prototype.stopDeployment = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/deployments/" + deployment + "/containers/stop";
                        return [4 /*yield*/, this.client.post(path)];
                    case 1:
                        status = (_a.sent()).status;
                        if (status != 202) {
                            throw new exceptions_1.KraneApiException("Unable to stop deployment");
                        }
                        return [2 /*return*/];
                }
            });
    ...
    KraneClient.prototype.restartDeployment = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/deployments/" + deployment + "/containers/restart";
                        return [4 /*yield*/, this.client.post(path)];
                    case 1:
                        status = (_a.sent()).status;
                        if (status != 202) {
                            throw new exceptions_1.KraneApiException("Unable to restart deployment");
                        }
                        return [2 /*return*/];
                }
            });
    ...
    KraneClient.prototype.getDeploymentContainers = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/deployments/" + deployment + "/containers";
                        return [4 /*yield*/, this.client.get(path)];
                    case 1:
                        data = (_a.sent()).data;
                        return [2 /*return*/, data];
    ...
    KraneClient.prototype.getDeploymentSecrets = function (deployment) {
        return __awaiter(this, void 0, void 0, function () {
            var path, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/secrets/" + deployment;
                        return [4 /*yield*/, this.client.get(path)];
                    case 1:
                        data = (_a.sent()).data;
                        return [2 /*return*/, data];
    ...
    KraneClient.prototype.addDeploymentSecret = function (deployment, key, value) {
        return __awaiter(this, void 0, void 0, function () {
            var path, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/secrets/" + deployment;
                        return [4 /*yield*/, this.client.post(path, { key: key, value: value })];
                    case 1:
                        data = (_a.sent()).data;
                        return [2 /*return*/, data];
                }
    ...
    KraneClient.prototype.deleteDeploymentSecret = function (deployment, key) {
        return __awaiter(this, void 0, void 0, function () {
            var path, status;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        path = "/secrets/" + deployment + "/" + key;
                        return [4 /*yield*/, this.client.delete(path)];
                    case 1:
                        status = (_a.sent()).status;
                        if (status != 200) {
                            throw new exceptions_1.KraneApiException("Unable to delete secret");
                        }
                        return [2 /*return*/];
                }
            });
...
exports.KraneClient = KraneClient;
...
var JobState;
(function (JobState) {
    JobState[JobState["STARTED"] = 0] = "STARTED";
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(8871), exports);
__exportStar(__webpack_require__(4421), exports);
...
__exportStar(__webpack_require__(8791), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(7152), exports);
__exportStar(__webpack_require__(1376), exports);
...
try {
  ...
  debug = __webpack_require__(7854)("follow-redirects");
}
catch (error) {
  debug = function () { /* */ };
}
...
module.exports = __webpack_require__(7796)(exports);
...
function setup(env) {
	...
	createDebug.humanize = __webpack_require__(4038);
...
try {
	...
	const supportsColor = __webpack_require__(5046);
...
const hasFlag = __webpack_require__(7300);
